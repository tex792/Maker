...
//int servoDelay = 100; //Set the delay between servo movements DELETE THIS WHEN I CHANGE THE SKETCH IN A BIT
                                                           ...
                                                           //steps the servo slowly from one to the other 
{
  ...
  int servoDelay = ((timeMove*60000)/abs(startServo-endServo));
